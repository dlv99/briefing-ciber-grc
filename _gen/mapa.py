...
NORMAS = [
 ("nis2","NIS2","Directiva (UE) 2022/2555","directiva",
  ...
  "La Comisión demandó a España, Irlanda, Francia y Países Bajos el 8 de julio de 2026, con petición de suma a tanto alzado y multa coercitiva diaria. Otros nueve países siguen en fase de dictamen motivado."),
 ("cer","CER","Directiva (UE) 2022/2557","directiva",
  ...
  "Siete Estados fueron remitidos al Tribunal de Justicia en 2026. No existe cifra pública de cuántos completaron la identificación de entidades críticas antes del plazo de julio."),
...
"nis2": {
 ...
 "NL":("tjue","Demandada el 8 de julio de 2026, y su ley se publicó dos días después. Situación real mejor de lo que sugiere la etiqueta."),
...
"cer": {
 ...
 "NL":("tjue","Ley en tramitación en la cámara baja, con el decreto de desarrollo aún en el Consejo de Estado."),
